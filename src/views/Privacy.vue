<template>
  <div class="max-w-6xl p-10 mx-auto my-16 text-white bg-primary rounded-xl">
    <h1 class="py-10 text-4xl font-extrabold text-center font-roboto">
      POLÍTICA DE PRIVACIDAD
    </h1>
    <p>
      El presente Política de Privacidad establece los términos en que newsbvb
    ...
    <p>
      ...
      cancelados en cualquier momento. newsbvb está altamente comprometido para
      cumplir con el compromiso de mantener su información segura. Usamos los
      sistemas más avanzados y los actualizamos constantemente para asegurarnos
    ...
    <p>
      ...
      un orden judicial. Newsbvb Se reserva el derecho de cambiar los términos
